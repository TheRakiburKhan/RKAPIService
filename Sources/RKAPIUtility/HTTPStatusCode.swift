...
public enum HTTPStatusCode: LocalizedError {
    ...
    public init(rawValue: Int) {
        if let standardStatus = StandardCode(rawValue: rawValue) {
            ...
            self = .custom(customCode: rawValue)
        }
    }
    ...
    public var response: HTTPStatusCode {
        return self
    }
    
    public var statusCode: Int {
        switch self {
            case .standard(let statusCode):
        ...
        switch self {
            case .standard(let code):
                switch code {
                    ...
                    case .conflict:
                        return "The request could not be processed because of conflict in the request, such as an edit conflict between multiple simultaneous updates."
